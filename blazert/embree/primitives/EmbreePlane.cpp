 ...
 */
EmbreePlane::EmbreePlane(const RTCDevice& device,
 ...
 */
void
planeBoundsFunc(const RTCBoundsFunctionArguments* args)
{
 ...
 */
void
planeOccludedFunc(const RTCOccludedFunctionNArguments* args)
{
