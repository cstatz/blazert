      ...
      SUBCASE("circular top/bottom") {
        ...
        SUBCASE("non-rotated") {
          ...
          SUBCASE("points inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0, 0.5, static_cast<T>(0.6)}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), 0, 0.5}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{-0.5, 0, static_cast<T>(-0.6)}, static_cast<T>(0.4));
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.75, static_cast<T>(0.1), 0}, static_cast<T>(0.2433627024789222));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.75, 0.5, 0}, static_cast<T>(0.09861218113400266));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.4), static_cast<T>(-0.8), 0},
                                       static_cast<T>(0.10557280900008405));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.4), 0, 0}, static_cast<T>(0.6));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.2), static_cast<T>(0.4), 0}, static_cast<T>(0.552786404500042));
          }
        ...
        SUBCASE("rotated") {
          ...
          SUBCASE("points inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, static_cast<T>(0.6), 0}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), 0.5, 0}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, 0, static_cast<T>(0.6)}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.6), 0, -0.5}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0, -0.5, -0.5},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-.1), 0.5, 0.5},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
          }
          SUBCASE("points outside") {
            const Mat3r<T> rot = blaze::IdentityMatrix<T>(3UL);
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.2), 0, 0.5}, static_cast<T>(0.2));
          }
        }
      }
      SUBCASE("elliptical cylinder (a = 1, b = 2)") {
        ...
        SUBCASE("non-rotated") {
          ...
          SUBCASE("points inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), 0.5, 0}, static_cast<T>(0.3648819183520901));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), -0.5, 0}, static_cast<T>(0.3648819183520901));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.6), 0.5, 0}, static_cast<T>(0.3648819183520901));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.6), -0.5, 0}, static_cast<T>(0.3648819183520901));

            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.2), 0.5, 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.2), 0.5, 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.2), -0.5, 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.2), -0.5, 0}, static_cast<T>(0.7602619863470543));

            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.7), static_cast<T>(1.2), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.7), static_cast<T>(-1.2), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.7), static_cast<T>(1.2), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.7), static_cast<T>(-1.2), 0},
      ...
      SUBCASE("elliptical cylinder (a = 2, b = 1)") {
        ...
        SUBCASE("non-rotated") {
          ...
          SUBCASE("points inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0, 0.5, 0}, static_cast<T>(0.5));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0, -0.5, 0}, static_cast<T>(0.5));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.6), 0, 0}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.6), 0, 0}, static_cast<T>(0.4));

            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), 0.5, 0}, static_cast<T>(0.4476319917487683));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.6), 0.5, 0}, static_cast<T>(0.4476319917487683));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.6), -0.5, 0}, static_cast<T>(0.4476319917487683));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-0.6), -0.5, 0}, static_cast<T>(0.4476319917487683));

            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, static_cast<T>(0.2), 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{-0.5, static_cast<T>(0.2), 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, static_cast<T>(-0.2), 0}, static_cast<T>(0.7602619863470543));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{-0.5, static_cast<T>(-0.2), 0}, static_cast<T>(0.7602619863470543));

            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.2), static_cast<T>(0.7), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-1.2), static_cast<T>(0.7), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.2), static_cast<T>(-0.7), 0}, static_cast<T>(0.09337334790470499));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(-1.2), static_cast<T>(-0.7), 0},
                                       static_cast<T>(0.09337334790470499));
          }
          SUBCASE("points outside") {
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.0, 0.0, 1.5}, static_cast<T>(0.5));
      ...
      SUBCASE("circular top/bottom") {
        ...
        SUBCASE("non-rotated") {
          ...
          SUBCASE("points inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1, static_cast<T>(1.6), 1.5}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1, 1.5, static_cast<T>(1.6)}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.6), 1, 1.5}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, 1, static_cast<T>(0.4)}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{0.5, 0.5, 1},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1.5, 1.5, static_cast<T>(0.9)},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
          }
          SUBCASE("points outside") {
        ...
        SUBCASE("rotated") {
          ...
          SUBCASE("point inside") {
            ...
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1.5, static_cast<T>(1.6), 1}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(1.6), 1.5, 1}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1.5, 1, static_cast<T>(1.6)}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.4), 1, 0.5}, static_cast<T>(0.4));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{1, 0.5, 0.5},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
            assert_distance_to_surface(cylinders, prim_id, Vec3r<T>{static_cast<T>(0.9), 1.5, 1.5},
                                       static_cast<T>(1. - std::sqrt(2) * 0.5));
          }
          SUBCASE("points outside") {
