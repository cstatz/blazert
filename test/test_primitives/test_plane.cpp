...
TEMPLATE_TEST_CASE("Plane", "[bounding box,  intersections]", float, double) {
  ...
  SECTION("BOUNDING BOX")
  {
    SECTION("unrotated")
    {
      ...
      Plane<TestType> sphere(*centers, *dxx, *dyy, *rotations);
    ...
    SECTION("Non rotated not in xy plane")
    {

      // plane on z=0, later rotated to x = 0
      // matrix which rotates the plane about the y-axis ( x = 0 is now plane eq)
      const Vec3r<TestType> axis{ static_cast<TestType>(1 / sqrt(2)), static_cast<TestType>(1 / sqrt(2)), 0 };
    ...
    SECTION("Arbitrary rotation for xy-plane about z-axis")
    {
  ...
  SECTION("INTERSECTS")
  {
    ...
    SECTION("Testing intersection functions for non rotated plane not in xy-plane")
    {
      // matrix which rotates the plane about the y-axis ( x = 0 is now plane eq)
      ...
      REQUIRE(hit_plane);
      REQUIRE(rayhit.prim_id == 0);
      REQUIRE(rayhit.hit_distance == Approx(5 * sqrt(2)));
      REQUIRE(rayhit.normal[0] == Approx(-1 / sqrt(2)));
      REQUIRE(rayhit.normal[1] == Approx(1 / sqrt(2)));
      REQUIRE(rayhit.normal[2] == Approx(0.f).margin(0.0001)); // for rotated planes, you can expect small numerical error
      // of size 1e16
    }
    SECTION("Testing intersection functions for non rotated plane not in xy-plane for ray origin outside plane boundaries")
    {
      // matrix which rotates the plane about the y-axis ( x = 0 is now plane eq)
      Mat3r<TestType> rot = blaze::IdentityMatrix<TestType>(3UL);
      rotations->push_back(rot);
      ...
      REQUIRE(hit_plane);
      REQUIRE(rayhit.prim_id == 0);
      REQUIRE(rayhit.hit_distance == Approx(4 * sqrt(2.f)));
      REQUIRE(rayhit.normal[0] == Approx(0.f).margin(0.0001));
      REQUIRE(rayhit.normal[1] == Approx(0.f).margin(0.0001));
      REQUIRE(rayhit.normal[2] == Approx(1.f));
      ...
      hit_distance = plane_intersector.hit_distance;
      hit_plane = intersect(plane_intersector, hit_distance, 0);
      update_intersector(plane_intersector, hit_distance, 0);
      ...
      REQUIRE(rayhit2.hit_distance == Approx(4. * sqrt(2.f)));
    ...
    SECTION("Testing intersection functions for plane xy-plane for edge intersection")
    {
      // matrix which rotates the plane about the y-axis ( x = 0 is now plane eq)
      Mat3r<TestType> rot = blaze::IdentityMatrix<TestType>(3UL);
      rotations->push_back(rot);
      ...
      REQUIRE(rayhit.normal[0] == Approx(1.f / sqrt(2)));
      REQUIRE(rayhit.normal[1] == Approx(0.f).margin(0.0001));
      REQUIRE(rayhit.normal[2] == Approx(1.f / sqrt(2)));
      ...
      REQUIRE(rayhit.hit_distance == Approx(4));
      REQUIRE(rayhit.normal[0] == Approx(0.f).margin(0.0001));
      REQUIRE(rayhit.normal[1] == Approx(1.f / sqrt(2)));
      REQUIRE(rayhit.normal[2] == Approx(1.f / sqrt(2)));
    ...
    SECTION("Testing intersection functions for plane xy-plane for corner intersection")
    {
      // matrix which rotates the plane about the y-axis ( x = 0 is now plane eq)
      Mat3r<TestType> rot = blaze::IdentityMatrix<TestType>(3UL);
      rotations->push_back(rot);
      ...
      REQUIRE(rayhit.prim_id == 0);
      REQUIRE(rayhit.hit_distance == Approx(4));
      REQUIRE(rayhit.normal[0] == Approx(1.f / sqrt(3)));
      REQUIRE(rayhit.normal[1] == Approx(1.f / sqrt(3)));
      REQUIRE(rayhit.normal[2] == Approx(1.f / sqrt(3)));
      ...
      Vec3r<TestType> dir3{ 0.f, 0.f, -1.f };
      const Ray<TestType> ray3{org3, dir2};
